...
\begin{frame}{Legacy system}
	\begin{flushleft}
		\textbf{\textcolor{red}{?} days, weeks, months} \\
		\textbf{\textcolor{red}{?} EUR} \\
	\end{flushleft}
\end{frame}
...
\begin{frame}{GIS.lab}
	...
	\end{itemize}
	\begin{flushleft}
		\textbf{\textcolor{red}{20} minutes} \\
		\textbf{\textcolor{red}{0} EUR} \\
	\end{flushleft}
\end{frame}
...
\begin{frame}{GIS.lab Unit}
	...
	\begin{columns}[T]
		\begin{column}{0.5\textwidth}
			...
			\end{itemize}
			\begin{flushleft}
				\textbf{\textcolor{red}{0} minutes} \\
				\textbf{\textcolor{red}{450} EUR} \\
			\end{flushleft}
		\end{column}
		\begin{column}{0.5\textwidth}
